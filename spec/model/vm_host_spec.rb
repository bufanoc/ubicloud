...
RSpec.describe VmHost do
  ...
  describe "#move_to_location" do
    it "updates location and downloads missing boot images" do
      target_location = Location[Location::HETZNER_HEL1_ID]
      BootImage.create(vm_host_id: vm_host.id, name: "ubuntu-noble", version: Config.ubuntu_noble_version, activated_at: Time.now, size_gib: 5)
